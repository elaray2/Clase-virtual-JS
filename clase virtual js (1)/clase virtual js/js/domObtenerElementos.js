...
cajas.forEach((caja) => {
	caja.innerHTML="<i>caja combio</i>"
	caja.textContent="caja combio1"
	caja.innerText="caja cambio2"
	console.log(caja);
...
*/
// first-child - last-child - nth-child(pod)
const ultimaCaja = document.querySelector('#contenedor2 .caja:nth-child(2)');
...
// console.log(contenedor2.querySelectorAll('div'));